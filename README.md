...
1. Clone the repository: `git clone https://github.com/NienCongChua/skin-notebook.git` or [download](https://github.com/NienCongChua/skin-notebook/archive/refs/heads/main.zip) to faster.
